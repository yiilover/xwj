      <!--Main Start-->
        <div id="main" class="marginbtm20">
        	<div class="indexMain">
            	<div class="indexLeft">
                	<div class="location marginbtm10"><h1><?php echo $info->category->title;?></h1><span>您的位置：<a href="<?php echo Yii::app()->params['siteurl'];?>" title="网站首页">网站首页</a>> <a href="<?php echo Yii::app()->createUrl('article/anli');?>" title="成功案例">成功案例</a>  > <a href="<?php echo Yii::app()->createUrl('article/index',array('cid'=>$info->cid))?>" title="<?php echo $info->category->title;?>"><?php echo $info->category->title;?></a></span></div>
