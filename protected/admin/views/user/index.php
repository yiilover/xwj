...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('user/create',array('menupanel'=>'usermanager|user|user_create'));?>'">添加用户</button>
