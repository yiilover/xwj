...
?>
<button class="sexybutton sexysimple sexylarge" onclick="window.location='<?php echo Yii::app()->createUrl('feedback/create',array('menupanel'=>'content|feedback|feedback_create'));?>'">添加留言反馈</button>
</div>
