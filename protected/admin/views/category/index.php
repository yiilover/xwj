...
?>
<button class="sexybutton" onclick="window.location='<?php echo Yii::app()->createUrl('category/create',array('menupanel'=>$_GET['menupanel'],'module'=>$_GET['module']));?>'"><span><span><span class="ok">添加分类</span></span></span></button>
